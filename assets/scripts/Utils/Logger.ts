...
export namespace Logger {
    ...
    export function log(...data: any[]) {
        ...
        backLog.call(null, "%c%s%s:%o", 'color: #075eff', getDateString(), stack(3), data);
    }
    ...
    export function warn(...data: any[]) {
        ...
        backLog.call(null, "%c%s%s:%o", 'color: #43bb88', getDateString(), stack(3), data);
    }
    ...
    export function error2(stackNum = 7, ...data: any[]) {
        // 标记没有打开，不打印该日志
        // if (!DEBUG) {
        //     return;
        // }
        ...
        var backLog = console.error ;
        backLog.call(null, "%c%s%s:%o", '', getDateString(), stack(stackNum), data);
    }
